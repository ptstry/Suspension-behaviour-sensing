...
public class Car extends PApplet{
  ...
  public void getData() {
    ...
    if(Buffer[0] != 0) {
      FL.setRot((float)(((0xFF & Buffer[0])*3)/(float)565.48667764616));
      FR.setRot((float)-(((0xFF & Buffer[2])*3)/(float)565.48667764616));
      RR.setRot((float)-(((0xFF & Buffer[3])*3)/(float)565.48667764616));
      RL.setRot((float)(((0xFF & Buffer[1])*3)/(float)565.48667764616));
      
      Camera.setMain((float)((((0xFF & Buffer[4])-127)*3)/(float)565.48667764616),
      (float)((((0xFF & Buffer[5])-127)*3)/(float)565.48667764616),
      (float)((((0xFF & Buffer[6])-127)*3)/(float)565.48667764616));
    }
